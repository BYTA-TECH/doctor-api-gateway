...
public interface SlotResourceApi {
    ...
    @ApiOperation(value = "searchSlots", nickname = "searchSlotsUsingGET", notes = "", response = SlotDTO.class, responseContainer = "List", tags={ "slot-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = SlotDTO.class, responseContainer = "List"),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden"),
        @ApiResponse(code = 404, message = "Not Found") })
    @RequestMapping(value = "/api/_search/slots",
        produces = "*/*", 
        method = RequestMethod.GET)
    ResponseEntity<List<SlotDTO>> searchSlotsUsingGET(@NotNull @ApiParam(value = "query", required = true) @Valid @RequestParam(value = "query", required = true) String query,@ApiParam(value = "Page number of the requested page") @Valid @RequestParam(value = "page", required = false) Integer page,@ApiParam(value = "Size of a page") @Valid @RequestParam(value = "size", required = false) Integer size,@ApiParam(value = "Sorting criteria in the format: property(,asc|desc). Default sort order is ascending. Multiple sort criteria are supported.") @Valid @RequestParam(value = "sort", required = false) List<String> sort);
